      ...
      <div className="card-list__buttons-container">
        <button
          className={`card-list__button ${
            props.isPrevBtnDisabled && "card-list__button_type_disabled"
          }`}
        ...
        <button className="card-list__button" onClick={props.handleCategoryClick}>
          Change Category
        </button>
        <button
          className={`card-list__button ${
            props.isNextBtnDisabled && "card-list__button"
          }`}
